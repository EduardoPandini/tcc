...
plt.figure(figsize=(14, 10))  # Ajuste do tamanho do gráfico
...
# plt.legend(legend_handles, legend_names.values(), title='Legenda', bbox_to_anchor=(1.05, 1), loc='upper left')
# plt.tight_layout()  # Ajusta o layout para evitar sobreposição

# Defina o caminho do diretório onde deseja salvar a imagem
save_directory = '/home/pandini/Desktop/thea/thea/imagens_dataset2'
